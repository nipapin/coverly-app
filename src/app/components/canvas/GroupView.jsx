...
export default function GroupView({ item }) {
  ...
  useEffect(() => {
    ...
    const width =
      item.width.unit === "pixels" ? item.width.value : layout.stage.width * item.width.value;
    const height =
      item.height.unit === "pixels" ? item.height.value : layout.stage.height * item.height.value;
